<?php defined('IN_DESTOON') or exit('Access Denied');?><?php $item['gu_price'] = $item['price']/100;?>
...
<strong>尊敬的<?php echo $value;?></strong>：<br/>
您好！<br/>
你有一件竞拍商品竞拍失败，保证金为<?php echo $item['gu_price'];?>元，已经归还您的账户，请注意查收。请访问以下链接查看竞价商品。
