...
<div class="m">
<div class="left_box">
<div class="pos">当1231前位置: <a href="<?php echo $MODULE['1']['linkurl'];?>">首页</a>
...
</div><?php echo tag("moduleid=$moduleid&condition=status=3&catid=$catid&areaid=$cityid&pagesize=15&page=$page&showpage=1&width=250&height=180&cols=3&datetype=5&order=".$MOD['order']."&target=_blank&lazy=$lazy&template=list-auction");?>
</div>
</div>
