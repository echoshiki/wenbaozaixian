...
<div class="main_body">
<div class="lh18 px13"><?php echo $content;?></div>
</div>
<?php } else { ?>
...
<tr>
<td><img src="<?php echo $COM['thumb'];?>" align="right" style="margin:5px 0 5px 10px;padding:5px;border:#C0C0C0 1px solid;"/><?php echo $content;?></td>
</tr>
</table>
</div>
</div>
...
<center><script type="text/javascript">document.write(player('<?php echo $video;?>',480,400,'',0));</script></center>
</div>
<?php } ?>
...
<td width="260"><?php echo $COM['company'];?></td>
<td width="90" class="f_b">公司类型：</td>
<td width="260"><?php echo $COM['type'];?> (<?php echo $COM['mode'];?>)</td>
</tr>
<tr>
...
<td><?php if($COM['capital']) { ?><?php echo $COM['capital'];?>万<?php echo $COM['regunit'];?><?php } else { ?>未填写<?php } ?>
</td>
...
<div class="main_body"><script type="text/javascript">Df('<?php echo $MODULE['3']['linkurl'];?>comment.php?mid=<?php echo $moduleid;?>&itemid=<?php echo $COM['userid'];?>', 'id="destoon_comment" style="width:100%;"');</script></div>
</div>
<?php } ?>
<?php } ?>
