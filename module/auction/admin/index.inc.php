...
if(in_array($action, array('', 'check', 'expire', 'reject', 'recycle'))) {
	...
	$sorder  = array('结果排序方式', '订单数量降序', '订单数量升序', '销售量降序', '销售量升序', '团购价降序', '团购价升序', '市场价降序', '市场价升序', '节省费用降序', '节省费用升序', '享受折扣降序', '享受折扣升序', '最多人数降序', '最多人数升序', '加价幅度降序', '加价幅度升序', '浏览人次降序', '浏览人次升序', '更新时间降序', '更新时间升序', VIP.'级别降序', VIP.'级别升序', '添加时间降序', '添加时间升序', '结束时间降序', '结束时间升序', '信息ID降序', '信息ID升序');
	...
	$_process = array(
	'<span style="color:#008000;">[竞拍中]</span>',
	'<span style="color:#0000FF;">[竞拍中]</span>',
